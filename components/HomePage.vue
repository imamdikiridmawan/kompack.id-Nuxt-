<template>
  <div class="home">
    ...
    <section id="section-3">
      ...
      <div
        class="row justify-content-center row-mobile-sect3"
        id="row-mobile-sect3"
      >
    ...
    <section id="section-4">
      <div class="container section-4" data-aos="zoom-in">
        ...
        <div class="row justify-content-between row-sect4">
          ...
          <div class="col-xl-4 col-lg-4 col-md-5 col-12 content-sect4-22">
        ...
        <div class="col-xl-6 col-lg-6 col-md-7 col-12 col2-sect7">
          <div class="subhead-sect7">
            <p>
              ...
              <span class="bold-sect7">Rp2.000/ barang yang terjual</span>
            </p>
          </div>
        </div>
      </div>
        ...
        <div class="container">
          <div class="row justify-content-evenly">
            ...
            >
              <div class="card">
                <div class="image">
                  <img src="../assets/partials/jne-counter.png" />
                </div>
                <span class="content">
            ...
            >
              <div class="card">
                <div class="image">
                  <img src="../assets/partials/sicepat-counter.png" />
                </div>
                <span class="content">
            ...
            >
              <div class="card">
                <div class="image">
                  <img src="../assets/partials/idexpress-counter.png" />
                </div>
                <span class="content">
                  <span style="color: #f95031"
        ...
        >
          <div class="col-xl-6 col-lg-6 col-md-6 col-12 p-4 mobile-layanan">
            ...
            <div class="row accordion-item row-layanan">
              <div
                class="col-lg-11 col-11 accordion-header subhead-layanan"
                id="flush-headingOne"
              >
                <div
      ...
      <div class="sect9">
        <div class="head-sect9 row justify-content-center">
          <h2 class="col-lg-11 col-md-12 col-10">
            Percayakan Layanan Pergudangan Bisnismu pada Kompack
          </h2>
        </div>
        ...
        <div class="button" id="5012227155521088">
          <a href="https://api.whatsapp.com/send?phone=6281328012118&text=Hi!&ensp;Kompack!&ensp;Saya&ensp;butuh&ensp;gudang,&ensp;bisa&ensp;tolong&ensp;dibantu?" class="btn-primary">
...
export default {
  ...
  methods: {
    ...
    handleDaftar() {
       if(process.client) {window.fbq('track', 'ViewContent')};
    }
  },
};
</script>
...
.section-4 {
  background-image: url(../assets/background/bg-sect4.svg);
...
/* alur */
.carousel-item {
  background-image: url(../assets/vector/line-new.svg);
  background-repeat: no-repeat;
  background-position: center;
}
...
.button .btn-primary {
  background-color: rgba(67, 197, 83, 1);
  padding: 15px;
  border-radius: 16px;
  font-weight: 600;
...
.custom__class::after {
  background-image: url(../assets/vector/bottom-arrow.svg);
  margin-right: 1rem;
}

.custom__class:not(.collapsed) {
...
@media (max-width: 350px) {
  ...
  .content-mobile-sect3 {
    margin-top: 5vh;
    margin-bottom: 3vh;
    box-shadow: 4px 4px 4px 4px rgb(0 0 0 / 12%);
    width: 80%;
    border-radius: 28px;
  }

  .content-mobile-sect3 img {
    margin-top: -10vh;
  }
  ...
  .row_sect-8 .col-tangerang .text-tangerang p {
    font-family: Poppins;
    font-size: 16px;
    font-weight: 600;
    line-height: 22px;
  ...
  .row_sect-8 .col-bekasi .text-bekasi p {
    font-family: Poppins;
    font-size: 16px;
    font-weight: 600;
    line-height: 22px;
...
@media (min-width: 768px) and (max-width: 992px) {
  ...
  .content-sect4-3[data-v-6d720fe5] {
    margin-top: 0vh;
    margin-bottom: 4vh;
  }
  ...
  .benefit-table-desktop li {
    font-size: 12px;
  }

  .benefit-table-desktop p {
    font-size: 12px;
  }
  ...
  .row_sect-8 .col-bekasi .icon-lokasi img {
    margin-bottom: 0;
  }
